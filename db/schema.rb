...
ActiveRecord::Schema.define(:version => 20130911130332) do
  ...
  create_table "spree_endpoint_messages", :force => true do |t|
    t.string   "message_id"
    t.string   "uri"
    t.string   "payload"
    t.string   "message"
  ...
  add_index "spree_endpoint_messages", ["message_id"], :name => "index_spree_endpoint_messages_on_message_id", :unique => true
